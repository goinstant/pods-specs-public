Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.platform-staging.goinstant.org/mobile/ios/sos/v0.1.13-rc/SOS-iOS-SDK-v0.1.13-rc.tar.gz' }
  s.platform = :ios, "7.0"
