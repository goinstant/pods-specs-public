Pod::Spec.new do |s|
  s.name         = "SOS"
  s.version      = "0.1.15-rc3-opentok-test-binary"
  s.platform     = :ios
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.platform-staging.goinstant.org/mobile/ios/sos/v0.1.15-rc3-opentok-test/SOS-iOS-SDK-v0.1.15-rc3-opentok-test.tar.gz' }
  s.platform = :ios, "6.1"
