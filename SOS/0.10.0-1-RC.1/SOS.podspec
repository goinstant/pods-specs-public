Pod::Spec.new do |s|
  s.name     = 'SOS'
  s.version  = '0.10.0-1-RC.1'
  s.author   = 'Salesforce'
  s.summary  = 'iOS SOS SDK'
  s.homepage = 'https://sos.goinstant.net'
  s.license  = { :type => 'MIT', :file => 'LICENSE' }

  s.source   = { :http => 'https://s3.amazonaws.com/sos.goinstant.net/ios/sdk/v0.10.0-1-RC.1/SOS-iOS-SDK-v0.10.0-1-RC.1.tar.gz' }
  ...
  s.dependency 'OpenTok', '2.4.1-RC.1'
