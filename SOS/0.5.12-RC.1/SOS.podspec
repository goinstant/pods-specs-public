Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.platform-staging.goinstant.org/mobile/ios/sos/v0.5.12-RC.1/SOS-iOS-SDK-v0.5.12-RC.1.tar.gz' }
  s.platform = :ios, "6.1"
