Pod::Spec.new do |s|
  s.name         = "SOS"
  s.version      = "0.3.1-rc-test-binary"
  s.platform     = :ios
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.platform-staging.goinstant.org/mobile/ios/sos/v0.3.1-rc-test/SOS-iOS-SDK-v0.3.1-rc-test.tar.gz' }
  s.platform = :ios, "6.1"
