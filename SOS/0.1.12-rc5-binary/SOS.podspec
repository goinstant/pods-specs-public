Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.platform-staging.goinstant.org/mobile/ios/sos/v0.1.12-rc5/SOS-iOS-SDK-v0.1.12-rc5.tar.gz' }
  s.platform = :ios, "7.0"
