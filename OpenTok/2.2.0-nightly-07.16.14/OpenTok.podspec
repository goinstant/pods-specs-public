Pod::Spec.new do |s|
  s.name     = 'OpenTok'
  s.version  = '2.2.0-nightly-07.16.14'
  s.author   = 'TokBox'
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/mobile.goinstant.org/228a5a06-9feb-4cef-9b72-9aac6b5b5234/OpenTok-SDK.2.2.0-nightly-07.16.14.tar.gz' }
