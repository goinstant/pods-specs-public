Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.goinstant.net/mobile/ios/goinstant/v0.2.3/GoInstant-iOS-SDK-v0.2.3.tar.gz' }

  
  s.dependency 'EngineIOClient', '0.2.1-binary'
