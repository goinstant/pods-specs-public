Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://s3.amazonaws.com/cdn.goinstant.net/mobile/ios/goinstant/v0.3.1/GoInstant-iOS-SDK-v0.3.1.tar.gz' }

  
  s.dependency 'EngineIOClient', '0.3.1-binary'
